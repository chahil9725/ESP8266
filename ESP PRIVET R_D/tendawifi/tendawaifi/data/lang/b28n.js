...
// 	versions 1.0
//  $Id: b28n.js 2013-4-7 09:42:30 taiji $
/***********************************************************************************************
************************************************************************************************/
...
(function (window) {
	...
	function replaceTextNodeValue(valObject, element){  
		...
		while (cur != null){
			if (cur.nodeType === 3 && /\S/.test(cur.nodeValue)){
				...
				isButton = cur.firstChild == null &&
						(btnStr.indexOf(cur.getAttribute("type")) !== -1);
						
				if (cur.getAttribute("value") && isButton &&
				...
				if(cur.getAttribute("alt") &&
						/\S/.test(cur.getAttribute("alt"))) {
					curValue = cur.getAttribute("alt").trim();
					if (valObject[curValue]) {
						cur.setAttribute("alt", valObject[curValue]);
					}
				}
	...
	function Butterlation() {
		...
		this.initializeDictionary = function() {
			...
			request.open("GET.html",this.po,false); 
